...
public class AMOrder extends DataEntity<AMOrder>{
	...
	private String payState;//支付成功失败flag 0成功 1失败
	private String expressName;//快递公司名称
	private String expressNo;//快递单号
	private String sendTime;//发货时间
	private String completeTime;//完成时间
	private int discountsNum;//订单优惠价数量
	
	private Date startTime;//起始时间
	private Date endTime;//结束时间
	private String userName;//用户名字
	private BigDecimal goodsMarket;//商品原价
	private BigDecimal goodsAllPrice;//商品全价
	private BigDecimal nowPay;//支付价格
	...
	public BigDecimal getGoodsMarket() {
		return goodsMarket;
	}
	public void setGoodsMarket(BigDecimal goodsMarket) {
