...
public class Page<T> {
	...
	private boolean isRelateQuery=false;//是否是关联查询，join,当为true时 表示自己计算总条数，否则框架计算
...
//	}
	...
	public boolean isRelateQuery() {
		return isRelateQuery;
	}

	public void setRelateQuery(boolean isRelateQuery) {
		this.isRelateQuery = isRelateQuery;
	}
