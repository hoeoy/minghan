...
//	private static OfficeDao officeDao = SpringContextHolder.getBean(OfficeDao.class);
	 ...
	 * @return
	 */
	public static List<Menu> getMenuList(String isShowHiddenMenu){
		List<Menu> menuList = null;//(List<Menu>)getCache(CACHE_MENU_LIST);
		if (menuList == null){
			Menu menu = new Menu();
			menu.setIsShowHiddenMenu(isShowHiddenMenu);
			String topHiddenParentId = "";
			menu.setTopHiddenParentId(topHiddenParentId);
			User user = getUser();
			if (user.isAdmin()){
