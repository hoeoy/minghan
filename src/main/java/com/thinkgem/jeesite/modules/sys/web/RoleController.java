...
//		model.addAttribute("menuList", systemService.findAllMenu("0"));
		model.addAttribute("menuList", systemService.findAllMenu("1"));
...
//		model.addAttribute("allUserList", systemService.findUserByParentId("0"));
	...
	public List<Map<String, Object>> users(String id, HttpServletResponse response) {
		List<Map<String, Object>> mapList = Lists.newArrayList();
//		User user = new User();
//		user.setParent(new User(id));
		//Page<User> page = systemService.findUser(new Page<User>(1, -1), user);
		id = StringUtils.isNotBlank(id) ? id:User.getRootId();
		List<User> userList = systemService.findUserByParentId(id);
		for (User e : userList) {
			Map<String, Object> map = Maps.newHashMap();
			map.put("id", e.getId());
			map.put("pId", e.getParent() == null ? User.getRootId():e.getParent().getId());
	...
	public String outrole(String userId, String roleId, RedirectAttributes redirectAttributes) {
		...
		if (!curUser.isAdmin() && curUser.getId().equals(userId)) {
