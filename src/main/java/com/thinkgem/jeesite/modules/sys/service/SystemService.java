...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<Menu> findAllMenu(String isShowHiddenMenu){
		return UserUtils.getMenuList(isShowHiddenMenu);
	}
...
//		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://jeesite.com\r\n");
	...
	public BigDecimal getBalanceById(String id) {
		...
		List<Balance> list = userDao.getBalanceById(id);
	...
	public void updateParentId(String id, String parentId) {
		userDao.updateParentId(id,parentId);
	}
