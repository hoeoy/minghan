 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/sys/jyuser")
public class jyUserController extends BaseController {
	@Autowired
	...
	public String list(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		for(int i=0;i<list.size();i++){
			...
			if(UserA==null||"".equals(UserA)){
				...
				UserA = UserAmbassador.userAmbassador(UserA);
			}
			list.get(i).setUserAmbassador(UserA);
		}
		page.setList(list);
        model.addAttribute("page", page);
		return "modules/sys/jyuserList";
	}
	...
	public String save(User user, HttpServletRequest request, Model model, RedirectAttributes redirectAttributes) {
		...
		if(Global.isDemoMode()){
			...
			return "redirect:" + adminPath + "/sys/jyuser/list?repage";
		}
...
//		user.setOffice(new Office(request.getParameter("office.id")));
		...
		return "redirect:" + adminPath + "/sys/jyuser/list";
	}
	...
	public String delete(User user, RedirectAttributes redirectAttributes,HttpServletRequest req) {
		...
		CacheUtils.remove(UserUtils.USER_CACHE, UserUtils.USER_CACHE_ID_ + id);
...
//			currentUser.setPhone(user.getPhone());
		...
		return "modules/sys/jysssuserInfo";
	}
