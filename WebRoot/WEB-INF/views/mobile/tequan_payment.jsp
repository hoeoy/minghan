		...
		<div class="mui-inner-wrap">
				...
				<div class="mui-scroll">
					...
					<ul class="mui-table-view mui-order-detail">
						<li class="mui-table-view-cell mui-collapse-content">
							<img class=" mui-pull-left" src="static/mobile/images/defult_img.png" onerror="this.src='static/mobile/images/defult_img.png';this.onerror=null;" >
							<div class="mui-media-body">
								<p class="store-title">${goods.name }</p>
								<p class="taocan-price"><span class="taocan-money">¥${goods.price }</span><span class="taocan-priced">¥${goods.market }<span class="mui-right">X1</span></span>
								</p>
							</div>
						...
						<li class="mui-table-view-cell mui-collapse-content goumai-detail">
							<p>购买详情</p>
								...
								<p>购买数量：<span>1</span></p>
								<p>手续费率：<span>0.6%</span></p>
								<p class="mui-text-right">应付金额:¥${goods.nowPrice}</p>
			...
			<nav class="mui-bar mui-bar-tab mui-goumai">
				<div class="total-price">
					总计<span>¥<span>${goods.nowPrice }</span></span>
				</div>
				<div class="mui-tab-item mui-zhifu-btn">
					<!-- <a href="javascript:showPayBox();" id="openPopover">余额支付</a> -->
					<a href="javascript:#popover-tequan" id="openPopover">去支付</a>
				</div>
			</nav>
				...
				<ul class="mui-table-view">
					...
					<form class="mui-input-group">
						<div class="mui-input-row mui-checkbox ">
							<label><img src="static/mobile/images/weixin_icon.png" />微信支付(¥${goods.nowPrice })</label>
					...
					<li class="mui-table-view-cell mui-collapse-content">
						...
						<span class="mui-right zhifu-money">¥${goods.nowPrice }</span>
					</li>
				</ul>
