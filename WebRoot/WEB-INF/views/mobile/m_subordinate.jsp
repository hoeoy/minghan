...
<html>
  <head>
	...
	<meta name="viewport" content="width=device-width,initial-scale=1,minimum-scale=1,maximum-scale=1,user-scalable=no" />
		...
		<link rel="stylesheet" type="text/css" href="static/mobile/css/tree.css" />
	<!--
 ...
 <script type="text/javascript">
	...
	$.ajax({
		url:"app/muser/seeSubordinate.do",
		data:{"id":id},
		type:"get",
		dataType:"json",
		success:function(data){
			...
			var html ="<tr class='outer'><td>";
			    ...
			    html+="<span class='text-indent'></span>";
			     } 
			    html+="<img src='"+s[i].minPhoto+"' class='touxiang'/>"+
				...
				"<tr class='inner'>"+
				"<td colspan='2'>"+
				"<table class='list-team' id='"+s[i].id+"' flag='"+flag+"'>"+
				"</table>"+
				"</tb>"+
				"</tr>";
				$('#'+id).append(html);
...
<!--		<div class="mui-off-canvas-wrap mui-draggable">-->
    ...
    <h1 class="mui-title">价格确认</h1>
				...
				<div class="mui-content mui-scroll-wrapper">
					...
					<p class="mui-text-center" style="margin: 20px auto;line-height:30px;">---暂无团队---</p>
					</c:if>
						<table id="listTable-team" class="list-team" style="position: relative;">
							...
							<c:forEach  var="list" items="${list}">
								...
								<tr class="inner">
								<td colspan="2">
								<table class="list-team" id="${list.id }" flag="1">
								</table>
								</td>
								</tr>
								</c:forEach>
