...
<meta name="renderer" content="webkit"><meta http-equiv="X-UA-Compatible" content="IE=8,IE=9,IE=10,IE=11" />
<meta http-equiv="Expires" content="0"><meta http-equiv="Cache-Control" content="no-cache"><meta http-equiv="Cache-Control" content="no-store">
<link rel="shortcut icon" type="image/x-icon" href="${ctxStatic}/favicon.ico">
...
<link href="${ctxStatic}/bootstrap/2.3.1/css_${not empty cookie.theme.value ? cookie.theme.value : 'cerulean'}/bootstrap.min.css" type="text/css" rel="stylesheet" />
<!--[if lt IE 9]>
  <script src="${ctxStatic}/bootstrap/3.3.7/js/html5shiv.min.js"></script>
  <script src="${ctxStatic}/bootstrap/3.3.7/js/respond.min.js"></script>
<![endif]-->
