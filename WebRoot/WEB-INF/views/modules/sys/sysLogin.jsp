...
<body>
	...
	<div class="header">
		<div id="messageBox2" class="alert2 alert-error2 ${empty message ? 'hide' : ''}"><button data-dismiss="alert" class="close">×</button>
