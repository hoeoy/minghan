...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sys/muser/parentform?id=${user.id}">推荐人设置</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/muser/parentsave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
...
<script type="text/javascript">
	function findUser(){
		...
		var url = "${ctx}/sys/muser/findUserList.do";
		$.ajax({
		url:url,
		type:'POST',
		data:{name:name},
